...
왓챠에서 4월 1일 <a href="https://watcha.com/netflix" target="_blank" >왓플릭스</a> 서비스(왓챠 추천 서비스를 기반으로 한 넷플릭스 추천 서비스)를 출시 한다고 해서 궁금해서 서비스를 이용해 봤습니다.
...
바로 <a href="https://www.netflix.com/title/80241239?s=i&trkid=13747225" target="_blank" >`로크 앤 키`</a> 입니다. 👍 

시즌2 제작도 확정됐다고 하니 꼭 한번 보세요~

<div class="alert alert-danger">
  <Badge pill variant="danger">청불</Badge>{' '}'로크 앤 키'는 청소년 관람불가네요. 미성년자분들은 볼 수 없답니다.
</div>

![Locke and Key](./locke-key_poster_head_key.jpg)
