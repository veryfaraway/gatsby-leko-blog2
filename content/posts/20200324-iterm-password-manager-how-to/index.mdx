...
![Password Manager](./iterm2-password-manager.png)
...
![계정추가 하기](./iterm_password_manager_input.png)
...
![Open Profile](./iterm-profile-edit.png)
...
![Trigger](./item-profile-trigger.png)
